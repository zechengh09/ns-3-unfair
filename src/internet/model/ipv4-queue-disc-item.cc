...
{
  NS_LOG_FUNCTION (this);
  if (!m_headerAdded && (m_header.GetEcn () == Ipv4Header::ECN_ECT1 || m_header.GetEcn () == Ipv4Header::ECN_ECT0 || m_header.GetEcn () == Ipv4Header::ECN_CE))
    {
...
bool
Ipv4QueueDiscItem::IsMarkable (void)
{
  NS_LOG_FUNCTION (this);
